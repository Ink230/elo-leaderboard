...
namespace NetCoreServer
{
    ...
    public class TcpServer : IDisposable
    {
        ...
        /// <summary>
        /// Multicast data to all connected sessions except the message sender
        /// </summary>
        /// <param name="buffer">Buffer to multicast</param>
        /// <param name="user">Session details of the one who sent the message</param>
        /// <returns>'true' if the data was successfully multicasted, 'false' if the data was not multicasted</returns>
        public virtual bool Multicast(byte[] buffer, Guid user) { return Multicast(buffer, 0, buffer.Length, user); }
        ...
        /// <param name="user">Session details of the one who sent the message</param>
        /// <returns>'true' if the data was successfully multicasted, 'false' if the data was not multicasted</returns>
        public virtual bool Multicast(byte[] buffer, long offset, long size, Guid user)
        {
            if (!IsStarted)
                return false;
        ...
        /// <param name="user">Session details of the one who sent the message</param>
        /// <returns>'true' if the text was successfully multicasted, 'false' if the text was not multicasted</returns>
        public virtual bool Multicast(string text, System.Guid user) { return Multicast(Encoding.UTF8.GetBytes(text), user); }
        #endregion
